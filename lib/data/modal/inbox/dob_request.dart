class RequestdobModel {
  bool? status;
  dynamic message;
  List<RequesdobData>? data;

  RequestdobModel({this.status, this.message, this.data});

  factory RequestdobModel.fromJson(Map<String, dynamic> json) {
    return RequestdobModel(
      status: json["status"] ?? false,
      message: json["message"] ?? "",
      data:
          (json["data"] as List?)
              ?.map((e) => RequesdobData.fromJson(e))
              .toList() ??
          [],
    );
  }
...
class RequesdobData {
  dynamic id;
  RequestDobModel? memberId;
  RequestDobModel? partnerId;
  dynamic status;
  dynamic createdAt;
  dynamic updatedAt;
  dynamic v;
  ...
  factory RequesdobData.fromJson(Map<String, dynamic> json) {
    return RequesdobData(
      id: json["_id"] ?? "",
      memberId: json["user_id"] != null
          ? RequestDobModel.fromJson(json["user_id"])
          : null,
      partnerId: json["member_id"] != null
          ? RequestDobModel.fromJson(json["member_id"])
          : null,
      status: json["status"] ?? "",
