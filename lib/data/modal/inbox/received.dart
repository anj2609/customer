class InboxReceivedModel {
  bool? status;
  dynamic message;
  List<InboxData>? data;

  InboxReceivedModel({this.status, this.message, this.data});

  factory InboxReceivedModel.fromJson(Map<String, dynamic> json) {
    return InboxReceivedModel(
      status: json["status"] ?? false,
      message: json["message"] ?? "",
      data:
          (json["data"] as List?)?.map((e) => InboxData.fromJson(e)).toList() ??
          [],
    );
  }
}
  ...
  factory InboxData.fromJson(Map<String, dynamic> json) {
    return InboxData(
      ...
      memberId: json["member_id"] != null
          ? UserModel.fromJson(json["member_id"])
          : null,
      partnerId: json["partner_id"] != null
          ? UserModel.fromJson(json["partner_id"])
          : null,
      status: json["status"] ?? "",
