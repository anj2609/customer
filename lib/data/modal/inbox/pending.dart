class InboxPenidngModel {
  bool? status;
  dynamic message;
  List<PendinginboxData>? data;

  InboxPenidngModel({this.status, this.message, this.data});

  factory InboxPenidngModel.fromJson(Map<String, dynamic> json) {
    return InboxPenidngModel(
      status: json["status"] ?? false,
      message: json["message"] ?? "",
      data:
          (json["data"] as List?)
              ?.map((e) => PendinginboxData.fromJson(e))
              .toList() ??
          [],
    );
  }
...
class PendinginboxData {
  dynamic id;
  PendingUserModel? memberId;
  PendingUserModel? partnerId;
  dynamic status;
  dynamic createdAt;
  dynamic updatedAt;
  dynamic v;
  ...
  factory PendinginboxData.fromJson(Map<String, dynamic> json) {
    return PendinginboxData(
      id: json["_id"] ?? "",
      memberId: json["member_id"] != null
          ? PendingUserModel.fromJson(json["member_id"])
          : null,
      partnerId: json["partner_id"] != null
          ? PendingUserModel.fromJson(json["partner_id"])
          : null,
      status: json["status"] ?? "",
