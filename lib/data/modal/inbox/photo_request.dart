class RequestphotoModel {
  bool? status;
  dynamic message;
  List<RequesphotoData>? data;

  RequestphotoModel({this.status, this.message, this.data});

  factory RequestphotoModel.fromJson(Map<String, dynamic> json) {
    return RequestphotoModel(
      status: json["status"] ?? false,
      message: json["message"] ?? "",
      data:
          (json["data"] as List?)
              ?.map((e) => RequesphotoData.fromJson(e))
              .toList() ??
          [],
    );
  }
...
class RequesphotoData {
  dynamic id;
  RequestPhotooModel? memberId;
  RequestPhotooModel? partnerId;
  dynamic status;
  dynamic createdAt;
  dynamic updatedAt;
  dynamic v;
  ...
  factory RequesphotoData.fromJson(Map<String, dynamic> json) {
    return RequesphotoData(
      id: json["_id"] ?? "",
      memberId: json["user_id"] != null
          ? RequestPhotooModel.fromJson(json["user_id"])
          : null,
      partnerId: json["member_id"] != null
          ? RequestPhotooModel.fromJson(json["member_id"])
          : null,
      status: json["status"] ?? "",
...
class RequestPhotooModel {
  ...
  factory RequestPhotooModel.fromJson(Map<String, dynamic> json) {
    return RequestPhotooModel(
      id: json["_id"] ?? "",
