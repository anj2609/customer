class InboxDeclinedModel {
  bool? status;
  dynamic message;
  List<DeclinedinboxData>? data;

  InboxDeclinedModel({this.status, this.message, this.data});

  factory InboxDeclinedModel.fromJson(Map<String, dynamic> json) {
    return InboxDeclinedModel(
      status: json["status"] ?? false,
      message: json["message"] ?? "",
      data:
          (json["data"] as List?)
              ?.map((e) => DeclinedinboxData.fromJson(e))
              .toList() ??
          [],
    );
  }
...
class DeclinedinboxData {
  dynamic id;
  DeclinedUserModel? memberId;
  DeclinedUserModel? partnerId;
  dynamic status;
  dynamic createdAt;
  dynamic updatedAt;
  dynamic v;
  ...
  factory DeclinedinboxData.fromJson(Map<String, dynamic> json) {
    return DeclinedinboxData(
      id: json["_id"] ?? "",
      memberId: json["member_id"] != null
          ? DeclinedUserModel.fromJson(json["member_id"])
          : null,
      partnerId: json["partner_id"] != null
          ? DeclinedUserModel.fromJson(json["partner_id"])
          : null,
      status: json["status"] ?? "",
...
class DeclinedUserModel {
  ...
  factory DeclinedUserModel.fromJson(Map<String, dynamic> json) {
    return DeclinedUserModel(
      id: json["_id"] ?? "",
