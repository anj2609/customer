class InboxShortlistProfileModel {
  bool? status;
  dynamic message;
  List<ShortlistedProfileinboxData>? data;

  InboxShortlistProfileModel({this.status, this.message, this.data});

  factory InboxShortlistProfileModel.fromJson(Map<String, dynamic> json) {
    return InboxShortlistProfileModel(
      status: json["status"] ?? false,
      message: json["message"] ?? "",
      data:
          (json["data"] as List?)
              ?.map((e) => ShortlistedProfileinboxData.fromJson(e))
              .toList() ??
          [],
    );
  }
...
class ShortlistedProfileinboxData {
  dynamic id;
  ShorlistedProfileUserModel? memberId;
  ShorlistedProfileUserModel? partnerId;
  dynamic status;
  dynamic createdAt;
  dynamic updatedAt;
  dynamic v;

  ShortlistedProfileinboxData({
    this.id,
    this.memberId,
    this.partnerId,
    this.status,
  ...
  factory ShortlistedProfileinboxData.fromJson(Map<String, dynamic> json) {
    return ShortlistedProfileinboxData(
      id: json["_id"] ?? "",
      memberId: json["member_id"] != null
          ? ShorlistedProfileUserModel.fromJson(json["member_id"])
          : null,
      partnerId: json["partner_id"] != null
          ? ShorlistedProfileUserModel.fromJson(json["partner_id"])
          : null,
      status: json["status"] ?? "",
...
class ShorlistedProfileUserModel {
  dynamic id;
  dynamic profileId;
  dynamic email;
  dynamic mobile;
  ...
  factory ShorlistedProfileUserModel.fromJson(Map<String, dynamic> json) {
    return ShorlistedProfileUserModel(
      id: json["_id"] ?? "",
