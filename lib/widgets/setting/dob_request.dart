...
class DobRequestScreen extends StatefulWidget {
  ...
  const DobRequestScreen({super.key, this.initialIndex = 0});

  @override
  State<DobRequestScreen> createState() => _DobRequestScreenState();
}
...
class _DobRequestScreenState extends State<DobRequestScreen>
  ...
  Widget _receivedTab(double w, double h) {
    ...
    return Obx(() {
      ...
      if (inboxCtrl.dobbbrequest.isEmpty) {
        return Center(
      ...
      return ListView.builder(
        itemCount: inboxCtrl.dobbbrequest.length,
        itemBuilder: (context, index) {
          final item = inboxCtrl.dobbbrequest[index];
