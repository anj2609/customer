...
class ColorResources {
  static Color primarycolor = const Color(0xFFA61D5B);
  static Color primarycolor2 = const Color(0xFFEB1D7B);
  static Color primarycolor3 = const Color(0xFFBF3272);
  static Color primarycolor4 = const Color(0xFF6C1A2F);
  static Color halkapink = const Color(0xFFFFE6F2);
